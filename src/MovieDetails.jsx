...
export function MovieDetails() {
	...
	if(!movie) return <p className='text-center mt-10 text-geay-400'>Movie not found 😒</p>
	return (
	<div className='min-h-screen px-6 py-10 bg-black text-white'>
      ...
      />
			<div className='flex-1 space-y-4'>
				...
				<p className='text-gray-300 text-sm'>Краткое описание фильма, жанр, год выходв, продолжительность и прочие данные</p>
			</div>
		</div>
	</div>)
}